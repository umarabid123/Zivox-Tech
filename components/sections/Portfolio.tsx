...
export default async function PortfolioSection() {
  ...
  return (
    ...
    <section className="section" style={{ paddingTop: '60px' }}>
      <div className="container">
        <AnimatedSection className="portfolio-filter reveal" variant="fadeIn">
        ...
        <StaggerContainer className="portfolio-grid reveal-stagger" style={{ gridTemplateColumns: '2fr 1fr 1fr', gridAutoRows: 'auto' }}>
          {items.length > 0 ? (
            items.map((it, idx) => {
