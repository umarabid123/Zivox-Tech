  ...
  return (
    ...
    <section className="page-header">
      <div className="container">
        ...
        <span className="eyebrow"><span className="dot"></span> &lt; 24h response · always</span>
        ...
        <div className="contact-grid">
          <div className="contact-info reveal">
            ...
            <div className="contact-detail">
              ...
              <div><div className="label">Email · for everything</div><div className="value">hello@nexvora.tech</div></div>
            </div>
            <div className="contact-detail">
