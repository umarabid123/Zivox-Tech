    ...
    <section className="section" style={{ paddingTop: '40px' }}>
      <div className="container">
        <div className="testimonial reveal" style={{ maxWidth: '760px', margin: '0 auto', padding: '48px' }}>
          ...
          <p className="quote" style={{ fontSize: '22px' }}>"Nexvora shipped Helix in eight working weeks. It's now the single tool our ops team opens every morning — and our retention metrics are visibly cleaner."</p>
